...
Gmin_phase_list = ['BCC_B2', 'DIS_FCC_A1', 'FCC_L12', 'HEUSLER_L21', 'SIGMA',
...
# print(len(FullEquil_results[0]))

# Merge results from different processes
list_of_conditions = [res[0] for res in FullEquil_results]
list_np_FCC_L12 = [res[1] for res in FullEquil_results]
list_np_FCC_L12_1 = [res[2] for res in FullEquil_results]
list_np_FCC_L12_2 = [res[3] for res in FullEquil_results]
