...
parfor comb_i = 1: length(comb_D_E)
    ...
    dst_file      = [dst_subfolder '/', '','v6_', comb_A_B_C_D_E_temp, '_SSS_FCC_byCompo.xlsx'];
    dst_file_at   = [dst_subfolder '/', '','v6_', comb_A_B_C_D_E_temp, '_SSS_FCC_byCompo_at_pct.xlsx'];


    %% --- save to at_pct and concatenate ele+composition into FORMULA

    table_comb_i_at_pct = readtable(dst_file,'VariableNamingRule','preserve');
    disp([comb_A_B_C_D_E_temp ': Processing Excel!']);
    ...
    ele_B_comb_i = 'Cr';
    ele_C_comb_i = 'Ni';
    ele_D_comb_i = comb_D_E{comb_i,1};
    ele_E_comb_i = comb_D_E{comb_i,2};
