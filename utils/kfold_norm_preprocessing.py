...
def kfold_with_norm_H(X, Y, H, scaler_X, scaler_features, scaler_H, n_splits, n_repeats, random_state):
    """
    Wrapper function for kfold_split_and_normalize. Applies k-fold cross-validation and normalization to the input data sets.

    Returns four lists containing the split and normalized data for X, Y, and H respectively.
    """
...
def kfold_with_norm_C(X, Z, W, C, scaler_X, scaler_testing, scaler_features, scaler_C, n_splits, n_repeats, random_state):
    ...
    return kfold_split_and_normalize([X, Z, W, C],
                                     [scaler_X, scaler_testing,
                                         scaler_features, scaler_C],
                                     n_splits, n_repeats, random_state)
