...
class ModelExplainer:
    ...
    def _attributions_interactions_for_one_fold(self,
        ...
        if Y_shap_list[i].size != 0:
            ...
            #       attribution_values_oneFold.shape)
...
def process_inverse_norm_explainer_data(pred_norm_base_stack, pred_norm_shap_stack,
                                   shap_norm_stack,
                                   attribution_norm_stack, scaler_output):
    """
    ...
    attribution_norm_mean = np.mean(attribution_norm_stack, axis=0)
    attribution_norm_std = np.std(attribution_norm_stack, axis=0)
    ...
    return (pred_norm_base_mean, pred_norm_shap_mean, shap_norm_mean, attribution_norm_mean,
